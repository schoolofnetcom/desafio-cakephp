...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => 'editor', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'role' => 'Lorem ip',
                'created' => '2019-01-24 03:39:55',
                'modified' => '2019-01-24 03:39:55'
            ],
        ];
        parent::init();
    }
